...
%-------------------------------------------------------------------------%
% Date: 22/02/2022
% Author/s: Ariadna Sorribas Bono, Marc Lahoz Fernández
%
...
Fdata = [2 2 3*F
    3 2 2*F
    4 2 F]; % 2 means is in the y direction
...
% Compute the risk of buckling of all the bars
buckling(sig, mat, Tmat, n_el, x, Tn);
